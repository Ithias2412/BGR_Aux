class CfgMagazines 
{
	...
	class BGR_100Rnd_762x51_Mag: TCP_100Rnd_762x51_Mag
	{
		ammo = "BGR_B_762x51_Ball_Suppression";
		mass = 55.9973;
	};
	class TCP_200Rnd_762x51_Mag;
	class BGR_200Rnd_762x51_Mag: TCP_200Rnd_762x51_Mag
	{
		ammo = "BGR_B_762x51_Ball_Suppression";
		mass = 125.993925;
	};
	class TCP_4Rnd_127x99_Mag;
	class BGR_4Rnd_127x99_Mag: TCP_4Rnd_127x99_Mag
	{
		ammo = "BGR_B_127x99_Ball";
	};
	class TCP_20Rnd_65x48_Mag;
	class BGR_20Rnd_65x48_Mag: TCP_20Rnd_65x48_Mag
	{
